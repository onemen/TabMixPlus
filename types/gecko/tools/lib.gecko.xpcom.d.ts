...
interface nsIContentAnalysis extends nsISupports {
  ...
  cancelContentAnalysisRequest(aRequestToken: string, aNotifyObservers: boolean): void;
  ...
  setCachedResponse(aURI: nsIURI, aSequenceNumber: i32, aFlavors: string[], aAction: nsIContentAnalysisResponse.Action): void;
  getCachedResponse(aURI: nsIURI, aSequenceNumber: i32, aFlavors: string[], aAction: OutParam<nsIContentAnalysisResponse.Action>, aIsValid: OutParam<boolean>): void;
}
...
interface nsIContentSecurityPolicy extends nsISerializable, Enums<typeof nsIContentSecurityPolicy.CSPDirective> {
  ...
  readonly hasPolicyWithRequireTrustedTypesForDirective: boolean;
...
interface nsINotificationStorage extends nsISupports {
  put(origin: string, id: string, title: string, dir: string, lang: string, body: string, tag: string, icon: string, alertName: string, data: string, serviceWorkerRegistrationScope: string): void;
